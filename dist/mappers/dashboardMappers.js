...
exports.mapOrderRowToDashboardOrder = mapOrderRowToDashboardOrder;
exports.mapOfferRowToDashboardShopOffer = mapOfferRowToDashboardShopOffer;
exports.mapMessageRowToDashboardMessage = mapMessageRowToDashboardMessage;
function mapOrderRowToDashboardOrder(row, vehicleRow) {
    ...
    const vehicle = vehicleRow && typeof vehicleRow === "object"
        ? {
...
function mapOfferRowToDashboardShopOffer(row) {
    const mapped = {
        id: row.id,
        ...
        marginPercent: row.margin_percent !== null && row.margin_percent !== undefined
...
function mapMessageRowToDashboardMessage(row) {
    return {
        id: row.id,
        orderId: row.orderId,
