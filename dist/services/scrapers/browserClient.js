...
async function getBrowser() {
    ...
    logger_1.logger.info("[Browser] Launching enhanced stealth browser...");
...
async function checkIdle() {
    ...
    if (Date.now() - lastUsed > TIMEOUT_MS) {
        logger_1.logger.info("[Browser] Idle timeout, closing browser.");
...
async function withPage(callback) {
    ...
    try {
        ...
        logger_1.logger.error("[Browser] Page error", { error: error.message });
        return null;
    }
    finally {
        await page.close();
