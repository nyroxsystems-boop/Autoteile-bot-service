...
async function generateOrderedMessages(orderId: string, customerContact: string, partName: string, count: number) {
    const messages = [
...
async function generateOrderedOffers(orderId: string, part: any) {
